...
import { useNotesStore } from '../stateStore';
...
const Note : FunctionComponent<NoteProps> = ({lst_edt_dt, previewtxt, lockStatus, previewtxtcol, bgCOL, noteid, gridview, opennotelarger}) => {
