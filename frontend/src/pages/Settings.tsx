...
export const Settings : FunctionComponent<SettingsProps> = ({apptheme, generalcs, changeTheme, changeGeneralCS}) => {
                        ...
                        () => {
                            switch(current_sub_settings){
                                case "Generalsettings":
                                    return <Generalsettings apptheme={apptheme} generalcs={generalcs}/>
